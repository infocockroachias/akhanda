  ...
  return (
    <div className="h-full w-full overflow-y-auto bg-white">
      <div className="max-w-4xl mx-auto px-4 py-16">
        <h1 className="text-4xl font-display font-bold text-gray-900 mb-8">About AkhandBharat</h1>
        ...
        <div className="max-w-none">
          ...
          <h2 className="text-2xl font-display font-semibold text-gray-900 mt-8 mb-4">How It Works</h2>
          ...
          <h2 className="text-2xl font-display font-semibold text-gray-900 mt-8 mb-4">Data Sources</h2>
          <p className="text-gray-600 mb-4 font-body">
          ...
          <h2 className="text-2xl font-display font-semibold text-gray-900 mt-8 mb-4">Features</h2>
          <ul className="list-disc list-inside text-gray-600 space-y-2 font-body">
