  ...
  return (
    <div className="h-full w-full overflow-y-auto">
      <div className="max-w-6xl mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold text-white font-playfair mb-2">Battles & Wars</h1>
        <p className="text-slate-400 mb-8">Major conflicts and wars in Indian history</p>
        ...
        <div className="flex flex-wrap gap-4 mb-8">
          <input
            ...
            className="flex-1 min-w-[200px] bg-slate-800 border border-slate-700 rounded-lg px-4 py-2 text-white placeholder-slate-400 focus:border-blue-500 focus:outline-none"
          />
          <select
            value={filter}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredBattles.map((battle, index) => (
            ...
            >
              ...
              <p className="text-sm text-white">{battle.text}</p>
              {battle.source && (
