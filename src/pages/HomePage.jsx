...
const HomePage = () => {
  ...
  return (
    <div className="h-full w-full overflow-y-auto bg-surface">
      {/* Hero Section */}
      <div className="relative h-[60vh] flex items-center justify-center bg-gradient-to-b from-primary-50 via-surface to-surface">
        <div className="text-center px-4 animate-fade-in">
          <h1 className="text-5xl md:text-6xl font-display font-bold text-surface mb-4">
            AkhandBharat
          </h1>
          <p className="text-xl text-muted mb-2 font-body">
            India's Interactive Historical Atlas
          </p>
          <p className="text-light max-w-2xl mx-auto mb-8 font-body">
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <h2 className="text-3xl font-display font-bold text-surface text-center mb-12">
          Features
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="card p-6">
            ...
            <h3 className="text-lg font-display font-semibold text-surface mb-2">Interactive Map</h3>
          ...
          <div className="card p-6">
            ...
            <h3 className="text-lg font-display font-semibold text-surface mb-2">Timeline Travel</h3>
            <p className="text-muted text-sm font-body">
          ...
          <div className="card p-6">
            ...
            <h3 className="text-lg font-display font-semibold text-surface mb-2">Kingdom Cards</h3>
            <p className="text-muted text-sm font-body">
          ...
          {featuredYears.map(({ year, title, description }) => (
            ...
            >
              <div className="flex items-center gap-3">
                <div className="text-2xl font-display font-bold text-primary-600 min-w-[80px]">
                  {year < 0 ? `${Math.abs(year)} BCE` : `${year} CE`}
                </div>
                <div>
                  <h3 className="font-display font-semibold text-surface">{title}</h3>
      ...
      {/* Stats */}
      <div className="bg-surface-alt border-t border-border py-12">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-3xl font-display font-bold text-primary-600">269</div>
              <div className="text-sm text-muted">Kingdoms</div>
            </div>
            <div>
              <div className="text-3xl font-display font-bold text-green-600">8,340+</div>
              <div className="text-sm text-muted">Territory Records</div>
            </div>
            <div>
              <div className="text-3xl font-display font-bold text-purple-600">746</div>
              <div className="text-sm text-muted">Historical Events</div>
            </div>
            <div>
              <div className="text-3xl font-display font-bold text-orange-600">149</div>
              <div className="text-sm text-muted">Dynasties</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <footer className="bg-surface border-t border-border py-8">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <p className="text-light text-sm font-body">
            AkhandBharat — Interactive Historical Atlas of India
          </p>
          <p className="text-light text-xs mt-2 font-body">
